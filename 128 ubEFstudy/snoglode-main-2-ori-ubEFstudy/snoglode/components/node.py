...
class UpperBoundNodeMetrics():
    ...
    def __init__(self) -> None:
        self.feasible = None
        self.objective = None
        # EF diagnostic fields
        self.ef_used = False        # Was EF used for candidate generation?
        self.ef_time_s = "-"        # Wall-clock seconds spent in EF solve
        self.ef_stop_reason = "-"   # Termination condition / status
