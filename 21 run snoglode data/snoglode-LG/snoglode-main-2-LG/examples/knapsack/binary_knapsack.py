"""
A basic capacitated knapsack example with binary variables
...
def knapsack_pyomo_model():
    """
    Builds basic knapsack model
    Used data from: https://jump.dev/JuMP.jl/stable/tutorials/linear/knapsack/
    """
    items = [1,2,3,4,5]
    profits = {1: 5, 
               2: 3, 
...
def subproblem_creator(_):
    ...
    complicating_variable_ids = {("item", i): model.x[i] \
