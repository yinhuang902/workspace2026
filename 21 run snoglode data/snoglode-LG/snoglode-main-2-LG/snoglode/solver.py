...
class Solver():
    ...
    def __init__(self, 
        ...
        self.lower_bounder = self._params._lower_bounder(solver = self._params._lb_solver,
                                                         inherit_solutions = self._params._inhert_solutions)
        ...
        # Wire global cut pool from tree to lower_bounder for LG branch-and-cut
        self.lower_bounder.cut_pool = self.tree.cut_pool
            ...
            (current_node.lb_problem.objective <= self.tree.metrics.ub):
                ...
                if (candidate_found):
                    ...
                    # otw, the candidate solution is representative of our ub feasible solution
                        ...
                        current_node.ub_problem.is_feasible(candidate_objective, candidate_solution)
                ...
                if (self.solve_ub):
                    ...
                    # update node metrics
                    if (ub_feasible): current_node.ub_problem.is_feasible(ub_obj, candidate_solution)
