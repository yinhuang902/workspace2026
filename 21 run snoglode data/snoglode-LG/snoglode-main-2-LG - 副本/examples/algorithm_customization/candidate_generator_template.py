...
class CustomCandidateGenerator(sno.AbstractCandidateGenerator):
    ...
    def __init__(self, 
                 solver: str, 
                 solver_options: dict, 
                 subproblems: sno.Subproblems, # used to attach a list of complicated_var_ids in the parent class
            ) -> None:
    ...
    def generate_candidate(self, 
        ...
        each of the complicating variables and a corresponding value.
