...
class Node():
    ...
    ----------
        ...
        ub_problem : UpperBoundNodeMetrics
            object holding all relevant information regarding the upper bound solve
            at this node.
        lb_problem : LowerBoundNodeMetrics
            object holding all relevant information regarding the lower bound solve
            at this node.
        terminal : bool
            indicates if this node is terminal (i.e. no more variables to branch on)
    """
    ...
    def __init__(self, 
        ...
        # LG specific state: multipliers for warm starting
        # Dictionary mapping complicating_var_id -> multiplier value
        self.lg_multipliers = {}
    ...
    def _init_psuedocost_data(self,
        ...
        branched_on : str
            complicating_var_id for which we branched on
        branched_on_avg : float
