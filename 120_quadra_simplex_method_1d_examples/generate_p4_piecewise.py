...
ITERATIVE_LOOP = """def run_iterative_splitting(Y0: Tuple[float, float], num_iterations: int = 5):
    ...
    for k in range(num_iterations):
        ...
        global_lb = min([s.lb for s in active_segments] + [worst_seg.lb]) if active_segments else worst_seg.lb
...
create_notebook('P4', 'P4', P4_DEFS)
print("P4 Piecewise Notebook saved!")
