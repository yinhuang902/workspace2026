...
class Solver():
    ...
    def dispatch_ub_solve(self,
        ...
        to the current objects in place.
        """
        TimeTracker().start("Upper Bound Solve")
        ...
        TimeTracker().stop("Upper Bound Solve")
