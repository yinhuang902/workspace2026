"""
problem_st_rv2.py -- Snoglode solver for SNGO-master/Global/st_rv2

Julia: NS=100, nfirst=5, nparam=5, seed=1234
Model: 20 vars (xi>=0), 10 <= constraints
...
_RHS_BASE = [405.0, 450.0, 430.0, 360.0, 315.0]
...
def build_scenario_model(scenario_name):
    ...
    # Constraints
    m.c1 = pyo.Constraint(expr=6*x[0] + 2*x[1] + 4*x[2] + 3*x[4] + 4*x[5] + 9*x[6] + 5*x[8] + x[9] + 9*x[10] + 6*x[11] + 7*x[13] + 9*x[14] + 2*x[15] + 8*x[17] + 2*x[18] + 4*x[19] <= rhs["c1_rhs"])
    m.c2 = pyo.Constraint(expr=6*x[0] + 5*x[1] + x[2] + 8*x[3] + 4*x[5] + 3*x[6] + 9*x[7] + 6*x[9] + 4*x[10] + 7*x[11] + 5*x[12] + 2*x[14] + 5*x[15] + 8*x[16] + 9*x[18] + 8*x[19] <= rhs["c2_rhs"])
    m.c3 = pyo.Constraint(expr=8*x[1] + 6*x[2] + 2*x[3] + 6*x[4] + 4*x[6] + 4*x[7] + 6*x[8] + 9*x[10] + 4*x[11] + 6*x[12] + 9*x[13] + 9*x[15] + 9*x[16] + 3*x[17] + x[19] <= rhs["c3_rhs"])
    m.c4 = pyo.Constraint(expr=8*x[0] + 7*x[2] + 3*x[3] + 2*x[4] + x[5] + 7*x[7] + 4*x[8] + 7*x[9] + 3*x[11] + 4*x[12] + x[13] + 6*x[14] + 2*x[16] + 8*x[17] + 9*x[18] <= rhs["c4_rhs"])
    m.c5 = pyo.Constraint(expr=x[0] + 5*x[1] + 5*x[3] + 5*x[4] + x[5] + 3*x[6] + 5*x[8] + 7*x[9] + 4*x[10] + 6*x[12] + x[13] + 3*x[14] + 4*x[15] + 3*x[17] + 5*x[18] + 5*x[19] <= rhs["c5_rhs"])
    
    m.c6 = pyo.Constraint(expr=x[0] + 8*x[1] + 7*x[2] + x[4] + 6*x[5] + x[6] + 6*x[7] + 7*x[9] + 3*x[10] + 6*x[11] + 4*x[13] + 6*x[14] + x[15] + 4*x[16] + x[18] + 4*x[19] <= 330)
    m.c7 = pyo.Constraint(expr=5*x[1] + 8*x[2] + 7*x[3] + 3*x[5] + 3*x[6] + 8*x[7] + 6*x[8] + 6*x[10] + 4*x[11] + 3*x[12] + 4*x[14] + 2*x[15] + 5*x[16] + 2*x[17] + 4*x[19] <= 350)
    m.c8 = pyo.Constraint(expr=x[0] + 3*x[2] + 2*x[3] + 7*x[4] + 2*x[6] + x[7] + x[8] + 7*x[9] + 4*x[11] + 3*x[12] + 5*x[13] + 3*x[15] + 6*x[16] + 3*x[17] + x[18] <= 245)
    m.c9 = pyo.Constraint(expr=5*x[0] + 5*x[1] + 2*x[3] + x[4] + 9*x[5] + 7*x[7] + 4*x[8] + 8*x[9] + 5*x[10] + 2*x[12] + 4*x[13] + 4*x[14] + 4*x[16] + 8*x[17] + 9*x[18] + x[19] <= 390)
    m.c10 = pyo.Constraint(expr=sum(x) <= 200)

    # Objective
    m.obj = pyo.Objective(expr=(
        -0.00015*(x[0])**2 - 0.0051*x[0] 
        - 0.00245*(x[1])**2 - 0.2205*x[1] 
        - 0.00095*(x[2])**2 - 0.0171*x[2] 
        - 0.0038*(x[3])**2 - 0.6384*x[3] 
        - 0.0029*(x[4])**2 - 0.435*x[4] 
        - 0.0024*(x[5])**2 - 0.4704*x[5] 
        - 0.0034*(x[6])**2 - 0.4556*x[6] 
        - 0.0018*(x[7])**2 - 0.2916*x[7] 
        - 0.00305*(x[8])**2 - 0.0549*x[8] 
        - 0.00025*(x[9])**2 - 0.0245*x[9] 
        - 0.00195*(x[10])**2 - 0.3588*x[10] 
        - 0.0008*(x[11])**2 - 0.1456*x[11] 
        - 0.0035*(x[12])**2 - 0.672*x[12] 
        - 0.0027*(x[13])**2 - 0.5184*x[13] 
        - 0.002*(x[14])**2 - 0.016*x[14] 
        - 0.0026*(x[15])**2 - 0.1404*x[15] 
        - 0.0048*(x[16])**2 - 0.2592*x[16] 
        - 0.00275*(x[17])**2 - 0.418*x[17] 
        - 0.00235*(x[18])**2 - 0.1081*x[18] 
        - 0.00275*(x[19])**2 - 0.264*x[19]
    ), sense=pyo.minimize)
...
if __name__=='__main__':
    ...
    if size==1:params.set_logging(fname=os.path.join(_log_dir,"problem_st_rv2_log"))
    else:params.set_logging(fname=os.path.join(_log_dir,"problem_st_rv2_log_parallel"))
    if rank==0:params.display()
    solver=sno.Solver(params)
    # ---------------------------------------------------------
    # CSV Logging Implementation (Monkey Patch)
    # ---------------------------------------------------------
    csv_filename=os.path.join(_log_dir,"problem_st_rv2_result.csv")
