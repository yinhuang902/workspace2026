"""
run_st_fp7c_case.py â€?Simplex runner for SNGO-master/Global/st_fp7c

Same constraints as st_fp7a (identical to 2_1_7).
Objective: Min Î£ (âˆ?0*xiÂ²) for i=1..20  (concave quadratic, no linear term)
"""
import argparse
...
def create_model_st_fp7c() -> pyo.ConcreteModel:
    ...
    # Objective: Min Î£ (âˆ?0*xiÂ²) for i=1..20
...
def main():
    ...
    print("="*60); print(f"st_fp7c (Python) â€?nfirst={nfirst}, nparam={nparam}, seed={args.seed}"); print("="*60)
    t0 = perf_counter()
