...
class SolverParameters():
    def __init__(self, 
        ...
        self._csv_log = False
        self._csv_logname = "solution_log"


    def set_csv_logging(self, 
                        fname: str = "solution_log") -> None:
        """
        Sets the file name for the CSV log that tracks solution progress per iteration.
        
        Parameters 
        -----------
        fname : str
            specifies the name of the file the log will live in (without extension)
        """
        assert type(fname) == str
        self._csv_log = True
        self._csv_logname = fname
