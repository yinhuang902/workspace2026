...
class SolverParameters():
    def __init__(self, 
        ...
        self._fbbt = False
        self._obbt = False
        self._obbt_solver_name = "gurobi"
        self._obbt_solver_opts = {}
    ...
    def set_quadratic_surrogate(self,
                                use_quadratic_surrogate: bool = True,
                                use_quadratic_lb: bool = True,
                                min_points: int = 10,
                                ridge: float = 1e-8,
                                box_width_threshold: float = 0.1,
                                gap_trigger_threshold: float = 1e-3,
                                always_compute: bool = False,
                                prune_csv_path: str = "pruned_lb_log.csv"):
        """
        Sets parameters for quadratic surrogate usage.
        """
        self._use_quadratic_surrogate = use_quadratic_surrogate
        self._use_quadratic_lb = use_quadratic_lb
        self._quad_min_points = min_points
        self._quad_ridge = ridge
        self._quad_box_width_threshold = box_width_threshold
        self._quad_gap_trigger_threshold = gap_trigger_threshold
        self._always_compute_quad_lb = always_compute
        self._prune_csv_path = prune_csv_path
        self._quad_max_dim_for_exact_min = 6 # Default for small problems