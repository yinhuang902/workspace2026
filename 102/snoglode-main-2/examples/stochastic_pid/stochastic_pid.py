...
if __name__ == '__main__':
    ...
    nonconvex_gurobi_lb.options["MIPGap"] = 0.1
    ...
    params.set_quadratic_surrogate(
        use_quadratic_surrogate=True,
        use_quadratic_lb=True,
        min_points=5,
        always_compute=False, # Use gating
        prune_csv_path="pruned_lb_log.csv"
    )
