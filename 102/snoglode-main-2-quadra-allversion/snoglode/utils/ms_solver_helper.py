...
def _solve_ms_dual_bound_gurobi(model: pyo.ConcreteModel, temp_obj_name: str) -> float:
    """
    ...
    try:
        # Solve without loading solutions (we only need the bound)
        results = ms_solver.solve(model, load_solutions=False)
